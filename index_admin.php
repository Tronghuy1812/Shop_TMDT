            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="./public/backend/chart.html">
                                <i class="fas fa-chart-bar"></i>Charts</a>
                        </li>
                        <li>
                            <a href="./public/backend/table.html">
                                <i class="fas fa-table"></i>Tables</a>
                        </li>
                        <li>
                            <a href="./public/backend/form.html">
                                <i class="far fa-check-square"></i>Forms</a>
                        </li>
                        <li>
                            <a href="./public/backend/calendar.html">
                                <i class="fas fa-calendar-alt"></i>Calendar</a>
                        </li>
                        <li>
                            <a href="./public/backend/map.html">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="./public/backend/login.html">Login</a>
                                </li>
                                <li>
                                    <a href="./public/backend/register.html">Register</a>
                                </li>
                                <li>
                                    <a href="./public/backend/forget-pass.html">Forget Password</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="./public/backend/button.html">Button</a>
                                </li>
                                <li>
                                    <a href="./public/backend/badge.html">Badges</a>
                                </li>
                                <li>
                                    <a href="./public/backend/tab.html">Tabs</a>
                                </li>
                                <li>
                                    <a href="./public/backend/card.html">Cards</a>
                                </li>
                                <li>
                                    <a href="./public/backend/alert.html">Alerts</a>
                                </li>
                                <li>
                                    <a href="./public/backend/progress-bar.html">Progress Bars</a>
                                </li>
                                <li>
                                    <a href="./public/backend/modal.html">Modals</a>
                                </li>
                                <li>
                                    <a href="./public/backend/switch.html">Switchs</a>
                                </li>
                                <li>
                                    <a href="./public/backend/grid.html">Grids</a>
                                </li>
                                <li>
                                    <a href="./public/backend/fontawesome.html">Fontawesome Icon</a>
                                </li>
                                <li>
                                    <a href="./public/backend/typo.html">Typography</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="index_admin.php?module=backend&controller=dashboard">
                                <i class="fas fa-tachometer-alt"></i>Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="index_admin.php?module=backend&controller=category">
                                <i class="fas fa-chart-bar"></i>Quản Lý Danh Mục</a>
                        </li>
                        <li>
                            <a href="index_admin.php?module=backend&controller=product">
                                <i class="fas fa-table"></i>Quản Lý Sản Phẩm</a>
                        </li>
                        <li>
                            <a href="index_admin.php?module=backend&controller=new">
                                <i class="far fa-check-square"></i>Quản Lý Tin Tức</a>
                        </li>
                        <li>
                            <a href="index_admin.php?module=backend&controller=bill">
                                <i class="fas fa-calendar-alt"></i>Quản Lý Đơn Hàng</a>
                        </li>
                        <li>
                            <a href="index_admin.php?module=backend&controller=user">
                                <i class="fas fa-calendar-alt"></i>Quản Lý Thành Viên</a>
                        </li>
                        <li class="./public/backend/has-sub">
                            <a class="js-arrow" href="#">
        ...
        <!-- HEADER DESKTOP-->
            ...
            <div class="main-content">
                ...
                <?php
                    ...
                    $controllerFile = $module === 'backend' ? "./Controllers/Backend/${controllerName}.php"
                    : './Controllers/Backend/DashboardController.php';
                    // echo $controllerFile;
                    ...
                    if (file_exists($controllerFile))
                    {
                        ...
                        echo "<h2>Không tìm thấy ${controllerName}";
