            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="index_admin.php?module=backend&controller=category&action=addCategory" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Name</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="name" placeholder="Tên nhóm sản phẩm"
                                        class="form-control">
                                    <small class="form-text text-muted">Vui lòng nhập tên nhóm sản phẩm</small>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text" name="ord" placeholder="ord"
                                        class="form-control">
